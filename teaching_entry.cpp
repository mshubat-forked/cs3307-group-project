...
void teaching_entry::set_record(int r)
{
    record=r;
}
int teaching_entry::get_record()
{
    return record;
}
void teaching_entry::set_user(string u)
{
    lm_user=u;
}
string teaching_entry::get_user()
{
    return lm_user;
}
void teaching_entry::set_date(string d)
{
    lm_date=d;
}
string teaching_entry::get_date()
{
    return lm_date;
}
void teaching_entry::set_ID(int i)
{
    ID=i;
}
int teaching_entry::get_ID()
{
    return ID;
}
void teaching_entry::set_member(string m)
{
    member_name=m;
}
string teaching_entry::get_member()
{
    return member_name;
}
void teaching_entry::set_domain(string d)
{
    primary_domain=d;
}
string teaching_entry::get_domain()
{
