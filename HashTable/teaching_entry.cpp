...
void teaching_entry::set_program(std::string p)
{
    program=p;
}
std::string teaching_entry::get_program()
{
    return program;
}
void teaching_entry::set_course_type(std::string c)
{
    course_type=c;
}
std::string teaching_entry::get_course_type()
{
    return course_type;
}
void teaching_entry::set_course(std::string c)
{
    course_type=c;
}
std::string teaching_entry::get_course()
{
    return course;
}
void teaching_entry::set_gscope(std::string g)
{
    geo_scope=g;
}
std::string teaching_entry::get_gscope()
{
    return geo_scope;
}
void teaching_entry::set_institution(std::string i)
{
    institution=i;
}
std::string teaching_entry::get_institution()
{
    return institution;
}
void teaching_entry::set_faculty(std::string f)
{
    faculty=f;
}
std::string teaching_entry::get_faculty()
{
    return faculty;
}
void teaching_entry::set_dept(std::string d)
{
    department=d;
}
std::string teaching_entry::get_dept()
{
    return department;
}
void teaching_entry::set_division(std::string d)
{
    division=d;
}
std::string teaching_entry::get_divison()
{
    return division;
}
void teaching_entry::set_location(std::string l)
{
    location=l;
}
std::string teaching_entry::get_location()
{
    return location;
}
...
void teaching_entry::set_faculty_comments(std::string fc)
{
    faculty_comments=fc;
}
std::string teaching_entry::get_faculty_comments()
{
    return faculty_comments;
}
std::string teaching_entry::get_student_names()
{
    return student_names;
}
void teaching_entry::set_student_names(std::string sn)
{
    student_names=sn;
}
...
std::string teaching_entry::get_comments()
{
    return comments;
}
void teaching_entry::set_comments(std::string c)
{
    comments=c;
}
void teaching_entry::set_other_details(std::string od)
{
    other_details=od;
}
std::string teaching_entry::get_other_details()
{
